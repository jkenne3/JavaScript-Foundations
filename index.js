...
mortgageCalculator(200000, .00416667, 360);
...
function task5mortgageCalculator(P,I,N,creditScore) {
    if (creditScore > 740){
        I = I - 0.005;
    }
    if (creditScore < 660){
...
task5mortgageCalculator(principal, monthlyInterestRate, periods, 650);
...
variableInterestRate(name, 200000, .04, 30);
